...
<p class="warning">
   Внимание! Помните, что изменение прав вступает в силу только после повторного входа в систему. Если пользователь активен, завершите сеанс и повторите процедуру логирования.
</p>
